...
Namespace FaucetPayPost
    Friend Class PostRequest
        ...
        Friend Function SEND(ByVal URL As String, ByVal Post As String, Optional ByVal Method As Method = Method.POST_, Optional ByVal Secure As Secure = Secure.TLS12) As String
