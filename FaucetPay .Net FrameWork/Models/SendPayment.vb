    ...
    Friend Class SendPayment
        ...
        Friend Function Send(API As String, Amount As String, To_ As String, ByVal Logs As Boolean, Optional Currency As String = "BTC", Optional Referral As Boolean = False, Optional IPAddress As String = "") As List(Of String)
            ...
            Try
                ...
                Send.Append(Deserealized.rate_limit_remaining)
                Send.Append(Deserealized.currency)
                Send.Append(Deserealized.balance)
                Send.Append(Deserealized.balance_bitcoin)
                Send.Append(Deserealized.payout_id)
                Send.Append(Deserealized.payout_user_hash)
            ...
            Catch ex As Exception
                Try
                    ...
                    Send.Append(Deserealized.message)
                    If Logs = True Then
                        Dim LOG As New FLog
