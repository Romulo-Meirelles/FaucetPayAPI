...
Namespace Models
    Friend Class GetListOfCurrencies
        ...
        Friend Function GetListCurrencies(API As String, ByVal Logs As Boolean) As List(Of String)
            ...
            Catch ex As Exception
                ...
                Catch exz As Exception
                    GetListCurrencies.Append(exz.Message)
                    If Logs = True Then
                        Dim LOG As New FLog
        ...
        Friend Function GetListCurrenciesNames(API As String, ByVal Logs As Boolean) As List(Of String)
            Dim Request As String = Nothing
            GetListCurrenciesNames = Nothing
            ...
            Catch ex As Exception
                Try
                    ...
                    End If
                    Return GetListCurrenciesNames.Append(Deserealized.message)
                Catch exz As Exception
                    If Logs = True Then
                        Dim LOG As New FLog
                        LOG.Loggs("Error Message: " & exz.Message)
                    End If
                    Return GetListCurrenciesNames.Append(exz.Message)
                End Try
            End Try
        End Function
    End Class
